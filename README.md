...
Updating this classic for the latest OS X.  My plans include the following upgrades:

- Allow all constants to show up in the equations as symbols -- not numbers.
- Make the number of digits user-adjustable.
- Remove the memory management and use ARC (done).
- Update the source code for Modern objective C (mostly done).
